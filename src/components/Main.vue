...
export default {
    ...
    created () {
        ...
        .then(res=>{
            ...
            for(var i = 0 ; i < 6; i++)
            {
                xAxis.push(this.newslist[i].provinceShortName);
                series1.push(this.newslist[i].confirmedCount);
                series2.push(this.newslist[i].deadCount);
                series3.push(this.newslist[i].curedCount);
